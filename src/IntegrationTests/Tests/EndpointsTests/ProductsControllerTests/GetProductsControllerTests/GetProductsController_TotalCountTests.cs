...
public class GetProductsController_TotalCountTests
{
    ...
    {
        int total = await Client.GetProductsTotal(new GetProductsRequestView(1, 1));
    ...
    {
        int total = await Client.GetProductsTotal(new GetProductsRequestView(0, 50, brand: "Apple"));
    ...
    {
        int total = await Client.GetProductsTotal(new GetProductsRequestView(1, 1, brand: "Apple"));
