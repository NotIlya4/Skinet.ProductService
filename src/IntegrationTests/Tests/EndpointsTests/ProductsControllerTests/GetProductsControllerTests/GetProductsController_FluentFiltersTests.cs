...
public class GetProductsController_FluentFiltersTests
{
    ...
    public async Task GetProducts_PassSearch_ProductsWithContainedSearch()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(0, 50, searching: "iPhone"));
    ...
    public async Task GetProducts_PassBrand_ProductsWithSpecifiedBrand()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(0, 50, brand: "Apple"));
    ...
    public async Task GetProducts_PassProductType_ProductsWithSpecifiedProductType()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(0, 50, productType: "Burger"));
    ...
    public async Task GetProducts_PassProductTypeWithBrand_ProductsWithOverlapOfProductTypeAndBrand()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(0, 50, brand: "Apple", productType: "Burger"));
    ...
    public async Task GetProducts_Limit1_FirstProduct()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(0, 1));
    ...
    public async Task GetProducts_Limit1Offset1_SecondProduct()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(1, 1));
    ...
    public async Task GetProducts_Limit1Offset1WithOtherFilters_SecondProductWithFilters()
    {
        ...
        JArray products = await Client.GetProducts(new GetProductsRequestView(1, 1, brand: "Apple", searching: "iPhone"));
